...
while carryOn:
    ...
    car_rect = yellow_car_scaled.get_rect(topleft = (carx+75,cary))
    car_rect.width = car_rect.width/3
    car_rect.height = car_rect.height-10
    ...
    pygame.draw.rect(screen,(100,0,100),car_rect)
